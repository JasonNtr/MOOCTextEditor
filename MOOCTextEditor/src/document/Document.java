...
public abstract class Document {
	...
	public static boolean testCase(Document doc, int syllables, int words, int sentences)
	{
		...
		//System.out.println("Sentences:"+sentFound+" Words:"+wordsFound+" Syllables"+syllFound);
		...
		if (passed) {
			...
			System.out.println("Flesh Score is: " +doc.getFleschScore()+ "\n");
		}
		else {
	...
	{  
		if((getNumWords()==0)|(getNumSentences()==0)) return 0;
		else {
		
		
	    double a=getNumWords()/getNumSentences();
	    double b=getNumSyllables()/getNumWords();
	    return 206.835-(1.015*a)-(84.6*b);}
